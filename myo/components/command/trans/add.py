...
def cons_vim_command(name: str, options: AddSystemCommandOptions) -> Either[str, Command]:
    return Command(name, VimInterpreter(options.silent | false), options.lines.o(options.line / List))
